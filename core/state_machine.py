...
class QuizcordStateMachine(object):
    ...
    def __init__(self, initial):
        ...
        self.machine.add_transition(
            trigger='edit_quiz_title',
            source='quiz_edit',
            dest='quiz_set_title'
        )
        self.machine.add_transition(
            trigger='quiz_title_changed',
            source='quiz_set_title',
            dest='quiz_edit'
        )

        self.machine.add_transition(
            trigger='edit_quiz_description',
            source='quiz_edit',
            dest='quiz_set_description'
        )
        self.machine.add_transition(
            trigger='quiz_description_changed',
            source='quiz_set_description',
            dest='quiz_edit'
        )

        self.machine.add_transition(
            trigger='select_question',
            source='quiz_edit',
            dest='question_select'
        )
        self.machine.add_transition(
            trigger='select_question_return',
            source='question_select',
            dest='quiz_edit'
        )

        self.machine.add_transition(
            trigger='edit_question',
            source='question_select',
            dest='question_edit'
        )

        self.machine.add_transition(
            trigger='edit_question_delete',
            source='question_edit',
            dest='question_select'
        )
        self.machine.add_transition(
            trigger='edit_question_return',
            source='question_edit',
            dest='question_select'
        )

        self.machine.add_transition(
            trigger='edit_question_text',
            source='question_edit',
            dest='question_set_text'
        )
        self.machine.add_transition(
            trigger='question_text_changed',
            source='question_set_text',
            dest='question_edit'
        )

        self.machine.add_transition(
            trigger='edit_question_explanation',
            source='question_edit',
            dest='question_set_explanation'
        )
        self.machine.add_transition(
            trigger='question_explanation_changed',
            source='question_set_explanation',
            dest='question_edit'
        )

        self.machine.add_transition(
            trigger='edit_question_media',
            source='question_edit',
            dest='question_set_media'
        )
        self.machine.add_transition(
            trigger='question_media_changed',
            source='question_set_media',
            dest='question_edit'
        )

        self.machine.add_transition(
            trigger='edit_question_answers',
            source='question_edit',
            dest='question_set_answers'
        )
        self.machine.add_transition(
            trigger='question_answers_changed',
